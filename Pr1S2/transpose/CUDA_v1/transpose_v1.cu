...
#define NTHREAD2D_X 32
#define NTHREAD2D_Y 32

__global__ void transpose_device_v1(const float *in, float *out, int n)
{
...
int main(int argc, char **argv)
{
    ...
    dim3 dimBlock(NTHREAD2D_X, NTHREAD2D_Y);
    dim3 dimGrid((n + NTHREAD2D_X - 1) / NTHREAD2D_X, (n + NTHREAD2D_Y - 1) / NTHREAD2D_Y);
    ...
    transpose_device_v1<<<dimGrid, dimBlock>>>(d_in, d_out, n);
